...
it starts into a configuration screen with nothing to run. ROMs are copyrighted
and not included — supply your own.
...
I've tried to reboot GSplus more than once. Each time I'd sink weeks into the
build system and packaging, and then life would pull me away for months,
sometimes years, and the momentum would die. This project does leverage AI to
allow me to provide some form of the emulator offering when I had time to write
it 100% myself.
